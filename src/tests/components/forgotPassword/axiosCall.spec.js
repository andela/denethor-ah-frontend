import forgotPassword from '../../../components/forgotPassword/forgotPasswordAction';
...
test('Should return email for successful call', async () => {
  ...
  const email = await forgotPassword('password');
...
test('Should return correct errors for erroneous calls', async () => {
  ...
  let error = await forgotPassword('password');
  ...
  error = await forgotPassword('password');
